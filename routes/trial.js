...
router.get("/", function(req, res, next) {
    // const query = "SELECT * FROM HackSCDeidentified";
    ...
    //     .protocol("https")
    //     .dbName("mapd")
    //     .user("wagotoxa@easy-apps.info")
    //     .password("tempdude1");
    //
    // con.connect(function(err, co) {
    //     console.log(co.sessionId());
    //     res.send("Hello world");
    // });

//     const Connector = require("@mapd/connector/dist/node-connector.js");
//
